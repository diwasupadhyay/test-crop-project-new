  ...
  const teamMembers = [
    {
      ...
      linkedin: 'https://linkedin.com/in/diwasupadhyay'
    },
    {
      id: 2,
      name: 'Myra Bhateja',
    ...
    },
    {
      ...
      image: null,
      quote: 'Engineering robust backends with data-driven insight.',
    ...
    >
      ...
      {(member.linkedin || member.github) && (
        <div className="flex justify-center gap-4 mt-8 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
          {member.linkedin && (
            <a href={member.linkedin} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-white/[0.05] flex items-center justify-center hover:bg-emerald-500/20 text-gray-500 hover:text-emerald-400 transition-all duration-300">
          ...
          {member.github && (
            <a href={member.github} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-white/[0.05] flex items-center justify-center hover:bg-emerald-500/20 text-gray-500 hover:text-emerald-400 transition-all duration-300">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
